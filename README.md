...
A .csv file with all prediction results can be downloaded by clicking FINAL_PREDS.csv (however, this file is 1.8 GB and will take a long time to download). The entire set of prediction structure files can be found within the Prediction_Structures folder (though there are many .gz files that will need to be unpacked, corresponding to the different MXene structure types/termination locations and number of X atoms (for example, the subfolder n3 corresponds to MXenes with 3 X atoms)). If you have any questions, please email me at  eric   timothy     warnemunde [at] gmail  .com           (put it all together).
...
<p align="center">
	  <img src="Figures/flowchart_smaller.png"/>
</p>
...
* [6] Emily Sutherland, Benjamin Traverso, and N. Aaron Deskins. Impact of composition on the structural, electronic, and mechanical properties of M3C2T2 MXenes. Mater. Adv. 2025. DOI: 10.1039/D5MA00874C. RSC. https://pubs.rsc.org/en/content/articlelanding/2025/ma/d5ma00874c
...
1. Eric Warnemunde Vertina, Emily Sutherland, Sajal Chakroborty, N. Aaron Deskins, and Oren Mangoubi. Machine-Learning-Enabled High-Throughput MXene Property Prediction. IEEE NAP 2025. https://ieeexplore.ieee.org/document/11216210
...
# More about me
LinkedIn Page: https://www.linkedin.com/in/eric-warnemunde-vertina-154740ba/
